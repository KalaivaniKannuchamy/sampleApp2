 ...
 */
const SubHeaderSmallBoldWhiteText = ({style, theme, fontWeight, ...rest}) => {
  return (
    <PaperText
...
SubHeaderSmallBoldWhiteText.propTypes = {
...
SubHeaderSmallBoldWhiteText.defaultProps = {};

export default withTheme(SubHeaderSmallBoldWhiteText);
